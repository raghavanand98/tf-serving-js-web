...
proto.tensorflow.AttrValue.ListValue.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    iList: jspb.Message.getRepeatedField(msg, 3),
    fList: jspb.Message.getRepeatedFloatingPointField(msg, 4),
    bList: jspb.Message.getRepeatedField(msg, 5),
    typeList: jspb.Message.getRepeatedField(msg, 6),
...
proto.tensorflow.AttrValue.ListValue.prototype.getBList = function() {
  return /** @type {!Array.<boolean>} */ (jspb.Message.getRepeatedField(this, 5));
};
