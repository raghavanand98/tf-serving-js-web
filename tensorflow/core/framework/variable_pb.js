...
proto.tensorflow.VariableDef.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    trainable: jspb.Message.getFieldWithDefault(msg, 7, false)
  };
...
proto.tensorflow.SaveSliceInfoDef.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    fullShapeList: jspb.Message.getRepeatedField(msg, 2),
    varOffsetList: jspb.Message.getRepeatedField(msg, 3),
    varShapeList: jspb.Message.getRepeatedField(msg, 4)
  };
